 <aside class="sidebar-wrapper">
         ...
         <ul class="metismenu" id="menu">
             ...
             <li>
                 ...
                 <ul>
                     ...
                     <li> <a href="app-chat-box.html"><span class="material-symbols-outlined">arrow_right</span>Chat
                             Box</a>
                     </li>
                     <li> <a href="app-file-manager.html"><span class="material-symbols-outlined">arrow_right</span>File
                             Manager</a>
                     </li>
     ...
     <div class="sidebar-bottom dropdown dropup-center dropup">
         <div class="dropdown-toggle d-flex align-items-center px-3 gap-3 w-100 h-100" data-bs-toggle="dropdown">
             ...
             <div class="user-info">
                 <h5 class="mb-0 user-name">Mahabubul Alam</h5>
                 <p class="mb-0 user-designation">We Developer</p>
             </div>
         </div>
